      ...
      <div className="p-6 sm:p-8 rounded-sm border border-white/10 bg-[#0a0a0d] flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
        ...
        <div className="flex flex-wrap gap-3 justify-center sm:justify-end">
          <a
            ...
            className="px-4 py-2.5 rounded-sm border border-white/20 hover:border-white text-white font-mono text-[9px] uppercase tracking-wider flex items-center gap-2 transition-colors hover:bg-white/5"
          >
            <MessageCircle size={13} className="text-[#ff7849]" />
            <span>{data.ctaTelegram}</span>
          </a>
          <a
            href="mailto:booking@beckerman.dj"
