...
export const translations: Record<'en' | 'cs' | 'ru', TranslationSet> = {
  en: {
    brandSub: "AFRO-HOUSE · HOUSE · DEEP-HOUSE · COMMERCIAL",
    brandStatus: "RESIDENT DJ // 500+ SHOWS",
    brandBpm: "AFRO-HOUSE · DEEP-HOUSE · COMMERCIAL",
    ...
    introDesc: "Premium club sets, private events and corporate shows across Prague and Europe. Specializing in Afro-House, House, Deep-House and Commercial — rich grooves, warm basslines and euphoric energy for every crowd and format.",
    metricEvents: "EXPERIENCE",
    metricEventsVal: "500+ SHOWS",
    metricStyle: "SOUND PALETTE",
    metricStyleVal: "AFRO · DEEP · HOUSE",
    ...
    hotspotScratchDesc: "The core stage is driven by three flagship Pioneer CDJ-2000 decks. Spin the interactive virtual jog wheel platter below or adjust the pitch fader to feel the immediate physical feedback and responsive timing of professional hardware.",
    ...
    riderDesc: "Impeccable signal precision. Performances are executed strictly on industry-standard, clean flagship equipment (3x CDJ-2000 coupled with the DJM-V10 mixer) wired with top-grade balanced Neutrik Pro XLR gold lines to eliminate jitters.",
    riderMetric1: "MAIN CONSOLE",
    riderMetric1Val: "3x CDJ-2000 & DJM-V10",
    ...
    specCat2_1d: "3x Pioneer CDJ-2000 multiplayer decks with MPU processors and hardware 3-Band Waveform analysis",
    ...
    bookLabelCity: "Event City",
    bookPlaceholderCity: "Prague, Czech Republic",
    bookLabelRider: "Audio Rider Configuration",
    bookRiderOption1: "Pioneer CDJ-2000 + DJM-V10 Rider",
    bookRiderOption2: "Pioneer CDJ-2000 + DJM-900NXS2 Setup",
    ...
    bookSuccessRiderType1: "PIONEER HIGH-PERF CDJ-2000 + DJM-V10 RIDER",
    bookSuccessRiderType2: "STANDARD PIONEER CDJ-2000 + DJM-900NXS2",
  ...
  cs: {
    ...
    introDesc: "Exkluzivní klubové sety, soukromé akce a firemní show v Praze i po celé Evropě. Specialista na Afro-House, House, Deep-House a Commercial — bohaté groovy, teplé baskytary a euforická energie pro každý formát.",
    metricEvents: "ZKUŠENOSTI",
    metricEventsVal: "500+ AKCÍ",
    metricStyle: "ZVUKOVÝ PROFIL",
    metricStyleVal: "AFRO · DEEP · HOUSE",
    metricLoc: "PŮSOBIŠTĚ",
    ...
    hotspotScratchDesc: "Hlavní performance je poháněna třemi vlajkovými loděmi Pioneer CDJ-2000. Roztočte interaktivní talíř níže nebo upravte pitch fader, abyste ucítili okamžitou fyzickou odezvu a přesnost profesionálního vybavení.",
    ...
    riderDesc: "Bezchybná přesnost signálu. Vystoupení probíhají výhradně na čistém standardním vlajkovém vybavení Pioneer (3x CDJ-2000 + mixážní pult DJM-V10) s použitím symetrických kabelů Neutrik Pro XLR zlacené řady pro eliminaci rušení.",
    ...
    specCat2_1d: "3x Pioneer CDJ-2000 s MPU procesorem a hardwarovou podporou 3pásmového Waveformu",
    ...
    bookSuccessRiderType1: "ŠPIČKOVÝ PIONEER CDJ-2000 + DJM-V10 RIDER",
    bookSuccessRiderType2: "KLASICKÝ PIONEER CDJ-2000 + DJM-900NXS2 SET",
  ...
  ru: {
    ...
    introDesc: "Премиальные клубные сеты, частные вечеринки и корпоративные шоу в Праге и по всей Европе. Специализация — Afro-House, House, Deep-House и Commercial: богатые грувы, тёплые бас-линии и эйфорическая энергия для любой аудитории.",
    metricEvents: "ОПЫТ ВЫСТУПЛЕНИЙ",
    metricEventsVal: "500+ СОБЫТИЙ",
    metricStyle: "ЗВУКОВОЙ СТИЛЬ",
    metricStyleVal: "AFRO · DEEP · HOUSE",
    ...
    hotspotScratchDesc: "Выступление ведется на трех флагманах CDJ-2000. Вращайте джог на интерактивной виртуальной деке ниже или измените питч темпа, чтобы почувствовать обратную связь и идеальный отклик профессионального оборудования.",
    ...
    riderDesc: "Безукоризненная точность сигнала. Выступления проводятся на флагманском оборудовании Pioneer (3x CDJ-2000 + DJM-V10) с использованием балансных кабелей Neutrik Pro XLR золотого сечения для устранения искажений и джиттера.",
    ...
    specCat2_1d: "3x Pioneer CDJ-2000 с процессором MPU и поддержкой Waveform 3-Band",
    ...
    bookLabelCity: "Город проведения",
    bookPlaceholderCity: "Прага, Чехия",
    bookLabelRider: "Конфигурация аудио-райдера",
    bookRiderOption1: "Райдер Pioneer CDJ-2000 + DJM-V10",
    bookRiderOption2: "Райдер Pioneer CDJ-2000 + DJM-900NXS2",
    ...
    bookSuccessRiderType1: "АНАЛОГОВЫЙ/ЦИФРОВОЙ ВЫСОКОКЛАССНЫЙ CDJ-2000 + DJM-V10 RIDER",
    bookSuccessRiderType2: "СТАНДАРТНЫЙ НАБОР PIONEER CDJ-2000 + DJM-900NXS2",
